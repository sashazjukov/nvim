...
syn keyword logLvError      ERROR ERRORS ERR E error Exception exception
...
syn match log_error 	'\c.*\<\(FATAL\|ERROR\|ERRORS\|exMessage\|exInnerException\|FAIL\|FAILED\|FAILURE\|Exception\|exception\).*'
