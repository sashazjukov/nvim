local pb_extensions = {
  srw = "NeoTreeFileNamePBWin",
  srd = "NeoTreeFileNamePBData",
  sra = "NeoTreeFileNamePBApp",
  srm = "NeoTreeFileNamePBMenu",
  srq = "NeoTreeFileNamePBQuery",
  srs = "NeoTreeFileNamePBStruct",
  sru = "NeoTreeFileNamePBObj",
  srj = "NeoTreeFileNamePBProj",
  pbl = "NeoTreeFileNamePBLib",
